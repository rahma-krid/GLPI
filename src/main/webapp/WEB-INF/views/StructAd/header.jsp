            ...
            <nav class="navbar navbar-default navbar-static-top no-margin" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-nav-expanded pull-right margin-md-right">
                    ...
                    <li class="hidden-xs">
                       ...
                       <h1>Poste Regionale de Sousse</h1>
                       ...
                       <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                           <i class="fa fa-bell-o" style="font-size: 1.8em;"></i> 
                            <span class="badge badge-up badge-danger badge-small"> ${fn:length(TVS)}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-notifications pull-right">
                            <li class="dropdown-title bg-inverse">Notifications ( ${fn:length(TVS)})</li>
                            <c:forEach var="T" items="${TVS }">
                            <li>
                                <a href="javascript:;" class="notification">
                                    ...
                                    <div class="notification-body">
                                        <strong>${T.superviseur.nom } ${T.superviseur.prenom }</strong><br>
                                          <small class="text-muted">${T.designation }</small><br>
                                        <small class="text-muted">${T.date_execution }</small>
                                    </div>
                                </a>
                            </li>
                      		 </c:forEach>
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle navbar-user" href="javascript:;">
                            ...
                            <span class="hidden-xs">${useer}</span>
                            <b class="caret"></b>
                        </a>
                ...
                <nav>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="#">
                            ...
                            <a href="techniciens" title="Dashboards">
                               <i class="fa fa-group" style="font-size:22px"></i> Gestion des Techniciens
                            </a> 
                      ...
                      <ul class="nav nav-pills nav-stacked">
                            ...
                            <ul class="nav-sub">
                                ...
                                <li>
                                    <a href="techrec" title="Profile">
                                        <i class="fa fa-fw fa-caret-right"></i> score par Technicien
